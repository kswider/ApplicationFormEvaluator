...
namespace ApplicationFormEvaluatorML.ConsoleApp
{
    public static class ModelBuilder
    {
        ...
        public static IEstimator<ITransformer> BuildTrainingPipeline(MLContext mlContext)
        {
            ...
            var trainer = mlContext.BinaryClassification.Trainers.SdcaLogisticRegression(labelColumnName: "Result", featureColumnName: "Features");
